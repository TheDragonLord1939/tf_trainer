...
BASE_CDN_DATA_DIR="obs://sprs-data-sg/Default/wucy/shareit_id_sample/double_feed_agg_duration/"

# 线上模型在obs上存放的目录
BASE_ONLINE_DICT_DIR="obs://sprs-data-sg/sharezone_model_server/online_dict/deep_models/"

# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/root/tf_trainer/online_dict/double_feed_agg_duration/"

# 执行run.sh相关任务的工作目录, 用于存放模型、日志等
WORK_DIR="/root/tf_trainer/work_dir/double_feed_agg_duration"
...
FEATURE_MAP_NAME="id_feed_click2.csv"
...
#---------- 模型更新校验参数配置 ----------#
VER_THRESH_AUC=0.60                     # 模型离线auc最低值
...
# 模型最低size, 单位为MB
VER_THRESH_MODEL_SIZE=200
#------------------------------------------#



#---------- 模型更新邮件通知配置 ----------#
MAIL_ADDRESS="wucy@ushareit.com"
MAIL_SUBJECT="Shareit ID DoubleFeed Duration DNN Model Updating"
#------------------------------------------#
