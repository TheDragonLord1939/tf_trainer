...
# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/root/tf_trainer/online_dict/ads_effective_deepfm"
...
FEATURE_MAP_NAME="ads_feature_v1.csv"
...
WORK_DIR="/root/tf_trainer/work_dir/ads_effective_deepfm/"

# 是否使用增量训练模式
USE_INCREMENT_MODE="True"

# 增量模型所在的本地目录, 若模型非增量设置为空即可
INCREMENT_MODEL_DIR="/root/tf_trainer/work_dir/ads_effective_deepfm/increment_model"
...
TASK_NAME="ads_effective_deepfm"
...
# 模型最低size, 单位为MB
VER_THRESH_MODEL_SIZE=50

## Mail Notice
MAIL_ADDRESS="luojl@ushareit.com"
MAIL_SUBJECT="ads_effective_deepfm Model Updating"
