...
BASE_CDN_DATA_DIR="obs://sprs-data-sg/sharezone_cdn/zhaoyq/test_seq_v8/"

# 线上模型在obs上存放的目录
BASE_ONLINE_DICT_DIR="obs://sprs-data-sg/sharezone_model_server/online_dict/deep_models"

# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/tf/tensorflow/online_dict/feed_ctr/"

# 执行run.sh相关任务的工作目录, 用于存放模型、日志等
WORK_DIR="/data2/tangkh/feed_model_seq_share/"
...
INCREMENT_MODEL_CLOUD_DIR="obs://sprs-data-sg/NeverDelete/tangkh/feed_ctr/increment_model"
...
# 多目标学习的任务数据集配置, 参考tf_trainer/models/__init__.py中的说明
MULTI_TASK_CONFIG=""
...
#---------- 模型更新邮件通知配置 ----------#
MAIL_ADDRESS="tangkh@ushareit.com,zhaoyq@ushareit.com"
