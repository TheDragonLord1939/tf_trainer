...
# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/root/tf_trainer/online_dict/ads_effective_deepfm_bias"
...
WORK_DIR="/root/tf_trainer/work_dir/ads_effective_deepfm_bias/"

# 是否使用增量训练模式
USE_INCREMENT_MODE="True"

# 增量模型所在的本地目录, 若模型非增量设置为空即可
INCREMENT_MODEL_DIR="/root/tf_trainer/work_dir/ads_effective_deepfm_bias/increment_model"
...
TASK_NAME="ads_effective_deepfm_bias"
...
MAIL_SUBJECT="ads_effective_deepfm_bias Model Updating"
