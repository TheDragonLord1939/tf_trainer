...
# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/root/nt_ad_tf_trainer/online_dict/ads_effective_nt"
...
FEATURE_MAP_NAME="ads_feature_v4.csv"
...
WORK_DIR="/root/nt_ad_tf_trainer/work_dir/ads_effective_nt/"

# 是否使用增量训练模式
USE_INCREMENT_MODE="True"

# 增量模型所在的本地目录, 若模型非增量设置为空即可
INCREMENT_MODEL_DIR="/root/nt_ad_tf_trainer/work_dir/ads_effective_nt/increment_model"
