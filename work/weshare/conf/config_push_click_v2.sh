...
BASE_CDN_DATA_DIR="obs://sprs-data-sg/sharezone_cdn/weianjun/push_click_v2/"

BASE_ONLINE_DICT_LOCAL_DIR="/data2/weianjun/online_dict/push_click_v2/"

BASE_ONLINE_DICT_DIR="obs://sprs-data-sg/push/online_dict/deep_models/"

ONLINE_DICT_NAME="push_dnn_test_model"

FEATURE_MAP_NAME="push_click_v2.csv"

RUN_DIR="./work/weshare"

WORK_DIR="/data2/weianjun/online_work_dir/push_click_v2"

INCREMENT_MODEL_DIR="/data2/weianjun/online_work_dir/push_click_v2/increment_model"
...
MAIL_SUBJECT="Push Test DNN of Click User Incremental Model Updating"
