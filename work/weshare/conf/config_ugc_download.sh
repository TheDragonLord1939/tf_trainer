...
BASE_CDN_DATA_DIR="obs://sprs-data-sg/sharezone_cdn/weianjun/ugc_download/"

# 线上模型在obs上存放的目录
BASE_ONLINE_DICT_DIR="obs://sprs-data-sg/sharezone_model_server/online_dict/deep_models"

# 线上模型在本地存放的目录
BASE_ONLINE_DICT_LOCAL_DIR="/data2/weianjun/online_dict/ugc_download/"

# 执行run.sh相关任务的工作目录, 用于存放模型、日志等
WORK_DIR="/data2/weianjun/online_work_dir/ugc_download/"
...
MAIL_SUBJECT="UGC Download DNN Model Updating"
#------------------------------------------#
