...
LOCAL_DATA_DIR="/data3/tangkh/recall_dnn"

# 本地训练的模型文件，会创建${LOCAL_MODEL_DIR}/$dt目录
LOCAL_MODEL_DIR="/tf/tensorflow/tf_trainer/work/shareit/model/recall_fm_duration"
...
ONLINE_DICT_NAME="dcn_client_model"
# ========== 目录相关参数 ========== #
...
FIXED_TRAINING_STEPS=1000000				# 固定训练步数，实际训练步数取决于数据量和固定训练步数的小者，开启后不运行early stop，也不做eval。0表示关闭
