...
OBS_DATA_DIR="obs://sprs-data-sg/sharezone/chengtx/sample/prerank_dssm_data"

# 本地训练数据存放目录，请使用绝对路径。会创建${LOCAL_DATA_DIR}/$dt/train和${LOCAL_DATA_DIR}/$dt/train/eval目录
LOCAL_DATA_DIR="/tf/tensorflow/tf_trainer/work/shareit/data/prerank_dssm"

# 本地训练的模型文件，会创建${LOCAL_MODEL_DIR}/$dt目录
LOCAL_MODEL_DIR="/tf/tensorflow/tf_trainer/work/shareit/model/prerank_dssm"
LOCAL_MODEL_SCHEMA="/tf/tensorflow/tf_trainer/work/shareit/conf/prerank_dssm_schema.csv"
...
CHECKPOINT_STEPS=5000					# 存储checkpoint的间隔
